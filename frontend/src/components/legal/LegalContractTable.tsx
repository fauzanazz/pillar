...
interface LegalContractsTableProps {
...
export function LegalContractsTable({
  contracts,
  currentPage,
  totalPages,
  totalItems,
              ...
              <TableRow>
                <TableCell colSpan={5}>
                  <div className="text-center py-8 text-gray-500">
                    No contracts found for legal review.
                  </div>
                </TableCell>
              </TableRow>
            )}
